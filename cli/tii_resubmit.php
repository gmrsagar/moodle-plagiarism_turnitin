...
WHERE assub.timemodified < (extract(epoch from now()) - 60 * 60 * 30) AND assub.status != \'draft\' AND assub.latest = 1 AND (ag.grade IS NULL OR ag.grade < 0) AND ptf.id IS NULL
